				...
				<div class="row">
					<div class="col-sm-3">
						<div class="profile-pic">
							<img src="resources/profilPic/dog.jpg" class="getimg" style="width: inherit; height: inherit;"/>
						</div>
					</div>
								...
								<div class="container">
									<div class="row">
										...
										<div class="col-sm-12">
											<div class="row">
												<div class="col-sm-2">
													<h6 class="light-text small-head bold-weight">가입일</h6>
												</div>
												<div class="col-sm-10">
								...
								<div class="container">
									<div class="row">
										...
										<div class="col-sm-12 pt-3">
											...
											<a href='/views/actionFv.do'><div class="sectional-tabs">액션</div></a>
